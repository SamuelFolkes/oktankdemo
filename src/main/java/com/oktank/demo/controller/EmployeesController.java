...
public class EmployeesController {
    ...
    public ResponseEntity<Employee> createEmployee(@RequestBody Employee newEmployee) {
        ...
        DataService ds = DataService.getInstance();
        ExecuteStatementResult result = ds.Query(String.format("INSERT INTO employees (id, name, department, photo_key, email, verified) VALUES (\'%s\', \'%s\', \'%s\', \'%s\', \'%s\', \'%s\')", dbEmployee.getId(), dbEmployee.getName(), dbEmployee.getDepartment(), dbEmployee.getId()+".jpg", dbEmployee.getEmail(), dbEmployee.getVerified()));
